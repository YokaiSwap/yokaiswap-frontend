...
export const getFaucetContract = (address: string, web3?: Web3) => {
  return getContract(faucetAbi, address, web3)
}
export const getStakingRewardsContract = (address: string, web3?: Web3) => {
  return getContract(stakingRewardsAbi, address, web3)
}
