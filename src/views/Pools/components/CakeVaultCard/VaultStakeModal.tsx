...
import { Modal, Text, Flex, Image, Button, Slider, BalanceInput, AutoRenewIcon } from '@yokaiswap/frontend-uikit'
    ...
    >
      <Flex alignItems="center" justifyContent="space-between" mb="8px">
        ...
        <Flex alignItems="center" minWidth="70px">
          <Image
            src={`/images/tokens/${stakingToken.symbol === 'YOK' ? 'yok' : getAddress(stakingToken.address)}.png`}
            width={24}
            height={24}
