...
import { CardHeader, Heading, Text, Flex, Image } from '@yokaiswap/frontend-uikit'
...
const StyledCardHeader: React.FC<{
  ...
  const isCakePool = earningTokenSymbol === 'YOK' && stakingTokenSymbol === 'YOK'
