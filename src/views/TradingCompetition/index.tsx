...
import { Flex, Box, Image } from '@yokaiswap/frontend-uikit'
...
const TradingCompetition = () => {
  ...
  useEffect(() => {
    const fetchCompetitionInfoContract = async () => {
      const competitionStatus = await tradingCompetitionContract.methods
        .currentStatus()
    ...
    const fetchUserContract = async () => {
      const user = await tradingCompetitionContract.methods
        .claimInformation(godwokenAddress)
        .call({ from: '0x3089EA87cD8dc04E0985E0C0DA272E399a7C289A' })
      const userObject = {
  ...
  }, [godwokenAddress, registrationSuccessful, claimSuccessful, tradingCompetitionContract])
