...
import { Button, Flex, Text, InjectedModalProps } from '@yokaiswap/frontend-uikit'
...
const StartPage: React.FC<StartPageProps> = ({ goToApprove, goToChange, goToRemove, onDismiss }) => {
  ...
  useEffect(() => {
    const checkApprovalStatus = async () => {
      const response = await cakeContract.methods
        .allowance(godwokenAddress, getPancakeProfileAddress())
  ...
  }, [godwokenAddress, cost, setNeedsApproval, cakeContract])
